...
down_revision: str | None = "a06446a7edd3"
...
def upgrade() -> None:
    ...
    op.create_index("ix_work_items_status_wake", "work_items", ["status", "wake_at"], unique=False)
    op.create_index(op.f("ix_work_items_principal"), "work_items", ["principal_id"], unique=False)
    op.create_index(op.f("ix_work_items_execution"), "work_items", ["execution_id"], unique=False)
