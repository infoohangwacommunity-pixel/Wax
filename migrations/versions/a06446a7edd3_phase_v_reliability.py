...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_audit_events_actor_principal_id"),
        "audit_events",
        ["actor_principal_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_audit_events_principal", "audit_events", ["actor_principal_id"], unique=False
    )
    op.create_table(
        "dead_letter_entries",
    ...
    op.create_index(
        op.f("ix_dead_letter_entries_principal_id"),
        "dead_letter_entries",
        ["principal_id"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_dead_letter_principal", "dead_letter_entries", ["principal_id"], unique=False
    )
    op.create_table(
        "principals",
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "interface_kind", "interface_message_id", name="uq_processed_messages_interface_id"
        ),
    )
    op.create_index(
        "ix_processed_messages_execution", "processed_messages", ["execution_id"], unique=False
    )
    op.create_index(
        "ix_processed_messages_principal", "processed_messages", ["principal_id"], unique=False
    )
    op.create_table(
        "roles",
    ...
    op.create_index(
        op.f("ix_conversations_principal_id"), "conversations", ["principal_id"], unique=False
    )
    op.create_index(
        "ix_conversations_principal_status",
        "conversations",
        ["principal_id", "status"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_executions_principal_id"), "executions", ["principal_id"], unique=False
    )
    ...
    op.create_index(
        "ix_memory_principal_kind", "memory_records", ["principal_id", "kind"], unique=False
    )
    op.create_index(
        "ix_memory_principal_status", "memory_records", ["principal_id", "status"], unique=False
    )
    op.create_index(
        op.f("ix_memory_records_principal_id"), "memory_records", ["principal_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_objectives_principal_id"), "objectives", ["principal_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_principal_credentials_principal_id"),
        "principal_credentials",
        ["principal_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_principal_roles_principal_id"), "principal_roles", ["principal_id"], unique=False
    )
    op.create_index(
        op.f("ix_principal_roles_role_id"), "principal_roles", ["role_id"], unique=False
    )
    op.create_table(
        "execution_steps",
    ...
    op.create_index(
        "ix_execution_steps_exec", "execution_steps", ["execution_id", "step_number"], unique=False
    )
    op.create_index(
